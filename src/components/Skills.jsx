...
export const skills = [
  ...
  { name: "Android Studio", icon: FaAndroid, proficiency: 60, color: "#3ddc84" },
  ...
  return (
    <section id="skills" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div
          ref={ref}
          className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-8 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-xl"
        >
